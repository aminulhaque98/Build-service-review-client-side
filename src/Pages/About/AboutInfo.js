...
const AboutInfo = () => {
    return (
        <div className='m-5 bg-orange-100 p-12 rounded-lg'>
            <h1 className="text-2xl font-bold m-2">Construction</h1>
            <p> Construction
                From Wikipedia, the free encyclopedia
                Jump to navigationJump to search
                For other uses, see Construction (disambiguation).
                "Construction site" redirects here. For the British children's TV series, see Construction Site (TV series).
                ...
                Contents
                1	History
                2	Construction industry sectors
                2.1	Building construction
                2.1.1	Residential construction
                2.1.2	Non-residential construction
                2.2	Infrastructure construction
                2.3	Industrial construction
                3	Construction processes
                3.1	Planning
                3.2	Finance
                3.3	Legal
                3.4	Procurement
                3.4.1	Traditional or Design-bid-build
                3.4.2	Design-build
                3.4.3	Construction management
                3.5	Design
                3.6	On-site construction
                3.7	Commissioning and handover
                3.8	Defects liability period
                3.9	Maintenance, repair and improvement
                3.10	Demolition
                4	Industry scale and characteristics
                4.1	Economic activity
                4.2	Construction GVA by country
                4.3	Employment
                4.3.1	Unskilled and semi-skilled workers
                4.3.2	Skilled tradespeople
                4.3.3	Professional, technical or managerial personnel
                4.4	Safety
                4.5	Sustainability
                5	See also
                ...
                Design-build became more common from the late 20th century, and involves the client contracting a single entity to provide design and construction. In some cases, the design-build package can also include finding the site, arranging funding and applying for all necessary statutory consents. Typically, the client invites several D&B contractors to submit proposals to meet the project brief and then selects a preferred supplier. Often this will be a consortium involving a design firm and a contractor (sometimes more than one of each). In the United States, departments of transportation usually use design-build contracts as a way of progressing projects where states lack the skills or resources, particularly for very large projects.[20]
                ...
                "Commonly Used Statistics: Worker fatalities". Occupational Safety and Health Administration. United States Department of Labor. Retrieved 1 March 2021.
                ...
                Wikimedia Commons has media related to Log cabin corner joints.
                ...
                82 more
                Edit links
                This page was last edited on 22 December 2022, at 08:05 (UTC).
